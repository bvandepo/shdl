...
public class CrapsTest {
	...
	public void writeMemory(long addr, long val) {
		...
		//System.out.println("wr mem, devrait être 1:" + (CommThread.readdByte(7) & 128));
		...
		//System.out.println("wr mem, devrait être 0:" + (CommThread.readdByte(7) & 128));
	}	
	...
	public long readMemory(long addr) {
		...
		do { } while ((CommThread.readdByte(7) & 128) == 0);
		// confirmation que mon_ack=1?
		//System.out.println("rd mem, devrait être 1:" + (CommThread.readdByte(7) & 128));
	...
	public long readRegister(int numreg) {
		...
		// confirmation que mon_ack=1?
		//System.out.println("readreg, devrait être 1:" + (CommThread.readdByte(7) & 128));
	...
	public void writeRegister(int numreg, long val) {
		...
		do { } while ((CommThread.readdByte(7) & 128) == 0);
		// confirmation que mon_ack=1?
		//System.out.println("wrreg, devrait être 1:" + (CommThread.readdByte(7) & 128));
