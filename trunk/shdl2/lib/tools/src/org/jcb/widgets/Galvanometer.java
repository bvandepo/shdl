...
public class Galvanometer extends JPanel {
	...
	public void paint(Graphics g) {
		...
		if (norm != null) {
			...
			myFillArc(g, size, 150 * size / 100, 130 * size / 100, angl1, angl2 - angl1 + 1);
...
g.setColor(Color.blue);
	...
	public static void main(String[] args) {
		...
		Galvanometer indic1 = new Galvanometer(50, "GLUC");
		indic1.setNorm(new FuzzyQuantity(1000., 1200., 100., 100., 0.), 0., 2000.);
		indic1.setValue(new FuzzyQuantity(950., 0.1));
		Galvanometer indic2 = new Galvanometer(50, "GLUC");
		indic2.setNorm(new FuzzyQuantity(1000., 1200., 100., 100., 0.), 0., 2000.);
		indic2.setValue(new FuzzyQuantity(850., 0.1));
		Galvanometer indic3 = new Galvanometer(50, "GLUC");
		indic3.setNorm(new FuzzyQuantity(1000., 1200., 100., 100., 0.), 0., 2000.);
		indic3.setValue(new FuzzyQuantity(750., 0.1));
		panel.add(indic1);
		panel.add(indic2);
		panel.add(indic3);
